...
<div class="vt-page">
  ...
  <div class="vt-table-wrap">
   <table class="vt-table" id="tablaVentas">
      <thead>
        <tr>
          <th>N° Venta</th>
          <th>Cliente</th>
...
document.addEventListener('DOMContentLoaded', function () {
    const tablaVentas = $('#tablaVentas').DataTable({
        ...
        pageLength: 10,
        searching: false,     // Oculta el buscador automático
        lengthChange: false,  // Oculta el selector de "Mostrar X registros"
        order: [[0, 'desc']], // Ordenar por la primera columna (Nro de Venta) descendente por defecto
        responsive: true,
        columnDefs: [
            { orderable: false, targets: -1 } // Desactivar ordenamiento en la columna de acciones (última)
        ]
    });
});
</script>
