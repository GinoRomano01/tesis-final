<?php
// app/views/include/header.php
// Header público — con campanita de notificaciones integrada
...
<!-- Toast — se mantiene solo para mensajes de acción puntual (login, guardado, error de checkout, etc.) -->
<!-- Las notificaciones persistentes ahora viven en la campanita, no acá -->
